...
resources:
    ...
    - src: assets/downloader.bmp
      name: downloader

    - src: assets/bscm.png
      name: bscm

    - src: assets/offculus.png
      name: offculus

    - src: assets/sncf_1.png
      name: sncf

    - src: assets/rgb_1.png
      name: ledcontrol

    - src: assets/amazfit_1.png
      name: amazfit

    - src: assets/heimdallite.png
      name: heimdallite

    - src: assets/gamelauncher.png
      name: dlauncher
...
<div class="row">
{{< projentry name="Kubernetes Infrastructure" link="https://github.com/drosocode/kube-infra-public" imgid="infra" date="2023" state="dev">}}
...
{{< projentry name="Arch Linux Dotfiles" link="https://github.com/drosocode/dotfiles_i3" imgid="dotfiles" date="2023" state="maint" >}}
...
<div class="row">
{{< projentry name="Zogwine Media Center" link="https://github.com/drosocode/zogwine" imgid="zogwine" date="2019" state="stale" >}}
...
{{< projentry name="Tachiwrapped" link="https://thomasz.me/tachiwrapped" imgid="tachiwrapped" date="2024" state="completed" >}}
...
<div class="row">
{{< projentry name="xpl2mqtt" date="2023" link="https://github.com/droso-hass/xpl2mqtt" imgid="x2m" state="stale" >}}
...
{{< projentry name="BlueRPC" date="2023" link="https://github.com/BlueRPC" imgid="bluerpc" state="stale" >}}
...
<div class="row">
{{< projentry name="ATV Remote" date="2023" link="https://github.com/drosocode/atvremote" imgid="atvremote" state="completed" >}}
Android TV / Google TV remote protocol implementation in golang.
{{< /projentry >}}

{{< projentry name="IDFM API" date="2022" link="https://github.com/droso-hass/idfm" imgid="idfmapi" state="maint" >}}
Python wrapper for Ile de france mobilités API and Home Assistant integration based on it.
{{< /projentry >}}
</div>

<div class="row">
{{< projentry name="EDF API" date="2022" link="https://github.com/droso-hass/edf-api" imgid="edf" state="deprecated" >}}
...
<div class="row">
{{< projentry name="DBackup" date="2021" link="https://github.com/drosocode/dbackup" imgid="dbackup" state="completed" >}}
...
{{< projentry name="NetBackup" date="2021" link="https://github.com/drosocode/netbackup" imgid="netbackup" state="completed" >}}
...
<div class="row">
{{< projentry name="IP Blocker" date="2021" link="https://github.com/drosocode/ipblocker" imgid="ipblocker" state="deprecated" >}}
Software to block IPs on OPNsense firewall based on a gelf stream from Graylog. Written in python.
{{< /projentry >}}

{{< projentry name="docker-bstreamer" date="2020" link="https://github.com/drosocode/docker-bstreamer" imgid="bstreamer" state="completed" >}}
...
<div class="row">
{{< projentry name="Marks Notifier" date="2021" link="https://github.com/drosocode/marksnotifier" imgid="marksnotif" state="arch" >}}
...
{{< projentry name="Downloader2" date="2020" link="https://github.com/drosocode/downloader2" imgid="downloader" state="arch" >}}
...
<div class="row">
{{< projentry name="BSCM" date="2020" link="https://github.com/drosocode/bscm" imgid="bscm" state="arch" >}}
Beat Saber Co-op Mod, written in C# to allow 2 player to play together, each one holding one saber.
{{< /projentry >}}

{{< projentry name="Offculus" date="2020" link="https://github.com/drosocode/offculus" imgid="offculus" state="arch" >}}
...
{{< projentry name="SNCF Bot" date="2022" link="https://gist.github.com/drosoCode/38ebbe7e7c765e890d2dd683c76d5d4c" imgid="sncf" state="deprecated" >}}
...
<div class="row">
{{< projentry name="NoUpdateLauncher" date="2021" link="https://github.com/drosocode/noupdatelauncher" imgid="noupdla" state="arch" >}}
...
{{< projentry name="Simple Docker UI" date="2020" link="https://github.com/drosocode/dockergui" imgid="dockergui" state="arch" >}}
...
<div class="row">
{{< projentry name="Streamdeck Plugins" date="2020" imgid="streamdeck" state="arch" >}}
...
{{< projentry name="LedControl" date="2018" link="https://github.com/drosocode/ledcontrol" imgid="ledcontrol" state="deprecated" >}}
...
<div class="row">
{{< projentry name="Synology Exporter" date="2021" link="https://github.com/drosocode/synologyexporter" imgid="synoex" state="arch" >}}
...
{{< projentry name="Amazfit Viewer" date="2020" imgid="amazfit" state="deprecated" >}}
...
<div class="row">
{{< projentry name="Heimdallite" date="2020" link="https://github.com/drosocode/heimdallite" imgid="heimdallite" state="deprecated" >}}
...
{{< projentry name="DLauncher" date="2019" link="https://github.com/drosocode/dlauncher" imgid="dlauncher" state="deprecated" >}}
...
{{< projentry name="P2P file exchange" date="2023" imgid="p2pfe" state="completed" >}}
...
{{< projentry name="Boron GO" date="2023" imgid="borongo" state="completed" >}}
...
{{< projentry name="Network Analyzer" date="2022" imgid="prjres" state="completed" >}}
...
{{< projentry name="Delivery App" date="2021" imgid="pizzarun" state="completed" >}}
...
<div class="row">
{{< projentry name="Balkanimes" date="2021" imgid="balkanimes" state="completed" >}}
...
{{< projentry name="Multiplayer Prophunt" date="2020" imgid="prophunt" state="completed" >}}
...
{{< projentry name="Static Website" date="2019" imgid="prjs1" state="completed" >}}
Static website built with bootstrap for our first semester project. Made with {{< link "https://github.com/clementd64" "Clement D" >}}.
{{< /projentry >}}

{{< projentry name="Solitaire" date="2019" imgid="prjs2" state="completed" >}}
...
-   {{< link "https://github.com/filebrowser/filebrowser/pull/1420" "Add OnlyOffice integration to filebrowser" >}} - {{< link "https://github.com/filebrowser/filebrowser/pull/2954" "Picked up by another contributor here" >}} - {{< link "https://github.com/gtsteffaniak/filebrowser/pull/297" "finally added in this project" >}}
...
<div class="row">
  <div class="col">
    <ul>
      <li><span style="color: #37BC7D">Dev: In active development</span></li>
      <li><span style="color: #2A9689">Stale: Development partly completed, on hold until I get some time</span></li>
      <li><span style="color: #D0872E">Maintenance: Mostly feature-complete, can receive occasional updates</span></li>
      <li><span style="color: #34A6F4">Completed: Considered feature-complete, does not requires any update</span></li>
      <li><span style="color: #A65F1B">Archived: Usable but will not receive any updates</span></li>
      <li><span style="color: #62748E">Deprecated: No longer maintained, has been superseeded by something else or is no longer usable</span></li>
    </ul>
  </div>
</div>
