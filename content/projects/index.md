...
<div class="row">
{{< projentry name="Kubernetes Infrastructure" link="https://github.com/drosocode/kube-infra-public" imgid="infra" >}}
...
{{< projentry name="Arch Linux Dotfiles" link="https://github.com/drosocode/dotfiles_i3" imgid="dotfiles" >}}
...
<div class="row">
{{< projentry name="Zogwine Media Center" link="https://github.com/drosocode/zogwine" imgid="zogwine" >}}
...
{{< projentry name="Tachiwrapped" link="https://thomasz.me/tachiwrapped" imgid="tachiwrapped" >}}
...
<div class="row">
{{< projentry name="xpl2mqtt" date="2023" link="https://github.com/droso-hass/xpl2mqtt" imgid="x2m" >}}
...
{{< projentry name="BlueRPC" date="2023" link="https://github.com/BlueRPC" imgid="bluerpc" >}}
...
<div class="row">
{{< projentry name="ATV Remote" date="2023" link="https://github.com/drosocode/atvremote" imgid="atvremote" >}}
Android TV / Google TV remote protocol implementation in golang.
{{< /projentry >}}

{{< projentry name="IDFM API" date="2022" link="https://github.com/droso-hass/idfm" imgid="idfmapi" >}}
Python wrapper for Ile de france mobilités API and Home Assistant integration based on it.
{{< /projentry >}}
</div>

<div class="row">
{{< projentry name="EDF API" date="2022" link="https://github.com/droso-hass/edf-api" imgid="edf" >}}
...
<div class="row">
{{< projentry name="DBackup" date="2021" link="https://github.com/drosocode/dbackup" imgid="dbackup" >}}
...
{{< projentry name="NetBackup" date="2021" link="https://github.com/drosocode/netbackup" imgid="netbackup" >}}
...
<div class="row">
{{< projentry name="IP Blocker" date="2021" link="https://github.com/drosocode/ipblocker" imgid="ipblocker" >}}
Software to block IPs on OPNsense firewall based on a gelf stream from Graylog. Written in python.
{{< /projentry >}}

{{< projentry name="docker-bstreamer" date="2020" link="https://github.com/drosocode/docker-bstreamer" imgid="bstreamer" >}}
...
<div class="row">
{{< projentry name="Bookmarks" date="2023" link="https://github.com/drosocode/bookmarks" imgid="bookmakrs" >}}
...
{{< projentry name="matrix-webhook" date="2022" link="https://github.com/drosocode/matrix-webhook" imgid="matrixwebhook" >}}
...
<div class="row">
{{< projentry name="Marks Notifier" date="2021" link="https://github.com/drosocode/marksnotifier" imgid="marksnotif" >}}
...
{{< projentry name="Downloader2" date="2020" link="https://github.com/drosocode/downloader2" imgid="downloader" >}}
...
<div class="row">
{{< projentry name="BSCM" date="2020" link="https://github.com/drosocode/bscm" imgid="bscm" >}}
Beat Saber Co-op Mod, written in C# to allow 2 player to play together, each one holding one saber.
{{< /projentry >}}

{{< projentry name="Offculus" date="2020" link="https://github.com/drosocode/offculus" imgid="offculus" >}}
...
{{< projentry name="SNCF Bot" date="2022" link="https://gist.github.com/drosoCode/38ebbe7e7c765e890d2dd683c76d5d4c" imgid="sncf" >}}
SNCF Auto Reservation bot using Appium to manipulate the android app and automatically book tickets on a regular basis.
{{< /projentry >}}

{{< projentry name="Dumpflow" date="2022" link="https://github.com/drosocode/dumpflow" imgid="=dumpflow" >}}
...
<div class="row">
{{< projentry name="NoUpdateLauncher" date="2021" link="https://github.com/drosocode/noupdatelauncher" imgid="noupdla" >}}
...
{{< projentry name="Simple Docker UI" date="2020" link="https://github.com/drosocode/dockergui" imgid="dockergui" >}}
...
<div class="row">
{{< projentry name="Streamdeck Plugins" date="2020" imgid="streamdeck" >}}
...
{{< projentry name="LedControl" date="2018" link="https://github.com/drosocode/ledcontrol" imgid="ledcontrol" >}}
...
<div class="row">
{{< projentry name="Synology Exporter" date="2021" link="https://github.com/drosocode/synologyexporter" imgid="synoex" >}}
...
{{< projentry name="Amazfit Viewer" date="2020" imgid="amazfit" >}}
...
<div class="row">
{{< projentry name="Heimdallite" date="2020" link="https://github.com/drosocode/heimdallite" imgid="heimdallite" >}}
...
{{< projentry name="DLauncher" date="2019" link="https://github.com/drosocode/dlauncher" imgid="dlauncher" >}}
...
{{< projentry name="P2P file exchange" date="2023" imgid="p2pfe" >}}
...
{{< projentry name="Boron GO" date="2023" imgid="borongo" >}}
...
{{< projentry name="Network Analyzer" date="2022" imgid="prjres" >}}
...
{{< projentry name="Delivery App" date="2021" imgid="pizzarun" >}}
...
<div class="row">
{{< projentry name="Balkanimes" date="2021" imgid="balkanimes" >}}
...
{{< projentry name="Multiplayer Prophunt" date="2020" imgid="prophunt" >}}
